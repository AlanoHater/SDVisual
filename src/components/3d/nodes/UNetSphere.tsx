...
export default function UNetSphere({ position, color, onClick, showLabel = true, isActive = false, pulseTick = 0 }: NodeProps) {
    ...
    >
      ...
      {showLabel && (
        <Html position={[0, 2.2, 0]} center pointerEvents="none">
          <div
            className="rounded-md border border-green-500/70 bg-slate-900/80 px-3 py-1 text-xs font-semibold tracking-wide text-green-300"
            style={{
              ...
              boxShadow: labelPulse ? '0 0 24px rgba(34,197,94,0.65)' : 'none',
              textShadow: labelPulse ? '0 0 8px rgba(134,239,172,0.95)' : 'none'
            }}
          >
            U-NET + SCHEDULER
          </div>
